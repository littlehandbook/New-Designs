  ...
  return <div className="flex h-screen bg-gray-50">
      ...
      <div className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 transform transition-transform duration-200 ease-in-out fixed lg:static inset-y-0 left-0 z-10 h-screen bg-gray-100 border-r border-gray-200 w-64 flex flex-col`}>
        ...
        <nav className="flex-1 pt-4 overflow-y-auto">
          <ul>
            <li>
              <Link to="/dashboard" className="flex items-center px-4 py-3 text-sm font-medium text-gray-700 hover:text-indigo-700 hover:bg-gray-50" onClick={() => setSidebarOpen(false)}>
            ...
            <li>
              <Link to="/calendar" className="flex items-center px-4 py-3 text-sm font-medium text-indigo-700 bg-indigo-50" onClick={() => setSidebarOpen(false)}>
